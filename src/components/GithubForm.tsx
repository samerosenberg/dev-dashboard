...
function GitHubForm(props: Props) {
    ...
    const [checkboxes, setCheckboxes] = useState([
        {
            id: "github_issues",
            label: "Issues",
            checked: dataProvider.filter((dp) => dp?.type === "github_issues").length > 0,
        },
        {
            id: "github_pull_requests",
            label: "Pull Requests",
            checked: dataProvider.filter((dp) => dp?.type === "github_pull_requests").length > 0,
        },
    ]);
